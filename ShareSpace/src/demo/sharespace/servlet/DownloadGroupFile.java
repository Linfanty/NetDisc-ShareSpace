 ...
 */
@WebServlet("/DownloadGroupFile") // 类级别的注解
...
public class DownloadGroupFile extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DownloadGroupFile() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String sql = "select filename, filepath from file,gfile where fileid = '" + fileId + "' and groupid = '" + groupid + "'";
