 ...
 */
@WebServlet("/ChangeDescServlet")
public class ChangeDescServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeDescServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "update file set filedesc = '"+filedesc+"'  where fileid = '" + fileid + "'";
			stmt.execute(sql);
			stmt.close();
